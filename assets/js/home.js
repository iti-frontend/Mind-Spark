...
function renderCard(categoryData) {
  ...
  card.innerHTML = `
        <div class="boxs__box">
            ...
            <div class="boxs__box__button display-h">
                <button class="display-h explore-btn">
                    Explore Now
  ...
  button.addEventListener("click", () => {
    const categoryParam = encodeURIComponent(categoryData.category);
    window.location.href = `questions.html?category=${categoryParam}`;
  });
